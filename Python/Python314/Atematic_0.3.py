...
stuff = []
jokes = ['Fucking', 'Poop', 'Fucker', 'Shit',
         'Motherfucker', 'Dipshit', 'Fuck']
if name in jokes:
    print(f"'{name}', really?")
    time.sleep(2)
...
while True:
    ...
    if 0 <= age <= 12:
        ...
        time.sleep(3)
        print("You see, I\'m a fairly lazy guy, so I didn\'t actually "
    ...
    if 13 <= age <= 26:
        ...
        time.sleep(4)
        print(f"{name}, I am completely aware that someone in this age"
              " bracket wants people around to share things with...")
        time.sleep(6)
        print("But I don't have enough knowledge for that kind of software,"
              " Do come back later, I'd love a chat")
        break
    if 27 <= age <= 50:
        print(f"{name}, I'm sure you've seen life a bit by now...")
        time.sleep(2)
        print("I'd love to know what's on your mind now but I don't have"
    ...
    if 51 <= age <= 75:
        ...
        time.sleep(3)
        print(f"{name}, Honestly, I don't have enough complexity to"
    ...
    if 76 <= age <= 120:
        ...
        print("...")
        time.sleep(5)
        print(f"{name}, I genuinely respect the veteran status"
              " and acquired accolades")
        time.sleep(4)
        print("I would love to absorb your wisdom, but I don't have the"
